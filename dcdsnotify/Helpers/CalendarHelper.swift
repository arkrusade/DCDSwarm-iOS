...
class CalendarHelper {
    ...
    static let errorActivity: Activity = Activity(classString: "", title: "Error", subtitle: "Failed to parse webpage")
    static let errorDay: Day = Day(activities: [errorActivity], date: NSDate())
        ...
        //TODO: add param for diff calendar lengths
    {
        ...
        do {
            ...
            while let okActivity = currentActivity {
                ...
                //removes currActivity from dayString by finding next start of activity
                //part of while loop logic
                ...
                let activityString = (try? okActivity.crop("etitle")) ?? "Activity Not Found"
